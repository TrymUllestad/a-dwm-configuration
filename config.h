...
static Key keys[] = {
	...
	{ MODKEY,                       XK_KP_End,	moveplace,      {.ui = WIN_SW }		},	// make client floating place it in 3x3 grid
	{ MODKEY,                       XK_KP_Down,	moveplace,      {.ui = WIN_S  }		},	// placement depends on which key in the keypad is pressed	
	...
	{ MODKEY,                       XK_z,		moveplace,      {.ui = WIN_C  }		},
